                        ...
                        <ul style="border: 1px solid #988c8c38 !important;" id="myTab" role="tablist"
                            ...
                            <li class="nav-item flex-sm-fill listrestheader">
                                <a href="#planetsPositionPage"
                                    onclick="showPage('planetsPosition', this),getPlanetsPosition()" data-toggle="tab"
                                    href="#home" role="tab" aria-controls="home" aria-selected="true"
                            ...
                            <li class="nav-item flex-sm-fill listrestheader">
                                <a id="kundli-tab" data-toggle="tab" href="#kundliPage" role="tab"
                                    onclick="showPage('kundli', this),getbirthChart()" aria-controls="contact"
                                    aria-selected="false"
                        ...
                        <div class="p-2 appform">
                            <div class="innerforms">
                                <div class="tableliner">
                                    <h5 class="birth" style="font-size: 17px;margin-bottom: 20px;">
                                        Panchang Details
