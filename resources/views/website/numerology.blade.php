...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('website/themes/astrologer/assets/css/astrologer-custom-style.css?ver=1')}}" />
    ...
    <div class="horoscope">
      <div class="horofirst">
        ...
        <div class="numrashitag">
          <div class="numlobox">
            <a href="#basicPage" class="numankr" onclick="NumeroLogy('basic')" style="font-size: 35px">
              <i class="fa-solid fa-arrow-up-from-bracket"></i></a>
            <a href="#introPage" class="numankr" onclick="NumeroLogy('intro')">01</a>
          </div>
          <div class="numlobox">
            <a href="#kundliPage" class="numankr" onclick="NumeroLogy('kundli')">02</a>
            <a href="#dashaPage" class="numankr" onclick="NumeroLogy('dasha')">03</a>
          </div>
          <div class="numlobox">
            <a href="#reportPage" class="numankr" onclick="NumeroLogy('report')">04</a>
            <a href="#leoPage" class="numankr" onclick="NumeroLogy('leo')">05</a>
          </div>
          <div class="numlobox">
            <a href="#virgoPage" class="numankr" onclick="NumeroLogy('virgo')">06</a>
            <a href="#libraPage" class="numankr" onclick="NumeroLogy('libra')">07</a>
          </div>
          <div class="numlobox">
            <a href="#scorpioPage" class="numankr" onclick="NumeroLogy('scorpio')">08</a>
            <a href="#sagittairusPage" class="numankr" onclick="NumeroLogy('sagittairus')">09</a>
          </div>
        </div>
      </div>
                  ...
                  <div class="hs_pr_second_cont_wrapper hs_ar_second_sec_cont_list_wrapper">
                    <ul>
                      ...
                      <li>
                        <div class="hs_pr_icon_cont_wrapper hs_ar_icon_cont_wrapper">
                          <p class="leadpoint">
                            Remember, while numerology can provide insights into your personality and tendencies, it's
                            not deterministic. You have the power to shape your own destiny through your actions,
