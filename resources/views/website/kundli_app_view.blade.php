          ...
          <div class="right-section">
            <div class="one">
              <p><strong>@lang('messages.name') :</strong> {{
                $basicUserDetails['full_name'] ?? '' }}</p>
              <p><strong>@lang('messages.date') :</strong> {{ $basicUserDetails['dob']
                ?? '' }}</p>
            </div>
            <div class="two">
              <p><strong>@lang('messages.time') :</strong> {{ $basicUserDetails['tob']
                ?? '' }}</p>
              <p><strong>@lang('messages.place') :</strong> {{
                $basicUserDetails['place'] ?? '' }}</p>
            </div>
          </div>
          ...
          <div class="ast_packages_wrapper ast_bottompadder70">
            <div class="appointfirst" style="margin: 40px auto;">
              ...
              <ul style="border: 1px solid #988c8c38 !important;" id="myTab"
                ...
                <li class="nav-item flex-sm-fill listrestheader ">
                  <a id="dasha-tab" data-toggle="tab" href="#dashaPage"
                    role="tab" onclick="showPage('dasha', this),getDashaChart()"
                    aria-controls="contact" aria-selected="false"
                ...
                <li class="nav-item flex-sm-fill listrestheader ">
                  <a id="dosha-tab" data-toggle="tab" href="#doshaPage"
                    role="tab"
    ...
    <script>
      function showPage(pageId, e) {
        ...
        function getPlanetsPosition() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-planetory-positions-app' }}";
            $('#preloader').show();
        ...
        function getBhavaKundliChart() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-bhava-kundli-charts-app' }}";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
        ...
        function getParyantardasha() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-paryantar-dasha-app' }}";
            $.ajax({
                url: url,
                type: 'GET',
                data: {
        ...
        function getMahadashaPrediction() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-mahadasha-prediction-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getSadheShatiTable() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-sade-sati-table-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getFriendshipTable() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-friendship-table-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getkpHousesPlanet() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-kp-houses-planet-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getGemSuggestion() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-gem-suggestion-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getRudrakshSuggestion() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-rudraksh-suggestion-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getPersonalCharacterstics() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-personal-characterstics-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getAscendantReport() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-ascendant-report-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
        ...
        function getKaalsharpDosha() {
            ...
            @elseif ($type === 'appointment'|| $type === 'phone')
                var vcMeetingId = "{{ $meeting_id }}";
            @endif
            var url = "{{ '/get-kaalsharp-dosha-app' }}";
            $('#preloader').show();
            $.ajax({
                url: url,
                type: 'GET',
