...
<html lang="en">
    ...
    <body>
            ...
            <div class="allpoints">
                <ol class="bold-numbers">
                    ...
                    <li>
                        ...
                        Astro-buddy.com ('Website'), including the related
                        mobile site and mobile application (hereinafter referred
                        to as 'Platform').
                    </li>
                    <li>
                        The Platform is owned by Astro Buddy, a company
                        incorporated under the Companies Act, 1956 with its
                        registered office at Jabalpur India (hereinafter
                        referred to as ‘Platform Owner’, 'we', 'us', 'our').
                    </li>
                    <li>
                        Your use of the Platform and services and tools are
                        governed by the following terms and conditions (“Terms
                        of Use”) as applicable to the Platform including the
                        applicable policies which are incorporated herein by way
                        of reference. If You transact on the Platform, You shall
                        be subject to the policies that are applicable to the
                        Platform for such transaction. By mere use of the
                        Platform, You shall be contracting with the Platform
                        Owner and these terms and conditions including the
                        policies constitute Your binding obligations, with
                        Platform Owner. These Terms of Use relate to your use of
                        our website, goods (as applicable) or services (as
                        applicable) (collectively, 'Services'). Any terms and
                        conditions proposed by You which are in addition to or
                        which conflict with these Terms of Use are expressly
                        rejected by the Platform Owner and shall be of no force
                        or effect. These Terms of Use can be modified at any
                        time without assigning any reason. It is your
                    ...
                    <li>
                        ...
                        context so requires 'you', 'your' or 'user' shall mean
                        any natural or legal person who has agreed to become a
        ...
        <div class="pointscircle">
            <div class="panditimg">
                <!-- <img src="/astro_buddy/public/images/pandit-hand.png" alt=""> -->
            </div>
            <!-- <h2>The use of Platform and/or availing of our Services is subject to the following Terms of Use:</h2> -->
            <div class="mainrishi">
                <!-- <img src="/astro_buddy/public/images/astro-banner-hand.png" alt=""> -->
            </div>
        </div>
        <ol class="sevenlines bold-numbers">
            <h2>The use of Platform and/or availing of our Services is subject to the following Terms of Use:</h2>
                ...
                <li>Neither we nor any third parties provide any warranty or guarantee as to the accuracy, 
                    ...
                    <li>Your use of our Services and the Platform is solely and entirely at your own risk and 
                        ...
                        <li>The contents of the Platform and the Services are proprietary to us and are licensed to us. 
                            You will not have any authority to claim any intellectual property rights, title, or interest in its contents. The contents includes and is not limited to the design, layout, look and graphics.</li>
                            <li>You acknowledge that unauthorized use of the Platform and/or the Services may lead to 
                                ...
                                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Jabalpur and Madhya Pradesh.</li>
