...
<html lang="en">
    ...
    <body>
        <div class="terms">
            ...
            <div class="lowertermsimg"></div>
        </div>
        <div class="condition">
            <div class="undercondition">
                <h3>
                Introduction
                    <hr class="privacyline" />
                </h3>
            </div>
            <div class="pripara">
                <p>
                This Privacy Policy describes how Astro-buddy.com Astro Buddy and its affiliates (collectively "Astro Buddy, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us.We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
                </p>
            </div>
            <div class="undercondition">
                <h3>
                Collection
                    <hr class="Collectionline" />
                </h3>
            </div>
            <div class="pripara">
                <p>
...
any information. If you receive an email, a call from a person/association claiming to be  Astro Buddy
...
these products/services may be affected in the event permission is not provided to us.
        ...
        <div class="bigpointspara">
        <div class="pointscircle">
            
        </div>
        
        <div class="pripara">
        <div class="undercondition" style='width:85%; margin:10px auto'>
                <h3>
                Sharing
                    <hr class="Sharingline" />
                </h3>
            </div>
                <p style='width:85%;'>
...
party; or protect the rights, property or personal safety of our users or the general public.
            ...
            <div class="pripara" style=' margin:10px auto; margin-top:-10px !important;'>
        <div class="undercondition" style='width:85%;'>
                <h3>
                Security Precautions
                    <hr class="Securityline" />
                </h3>
            </div>
                <p style='width:85%;'>
...
and password records for their account.
            ...
            <div class="pripara" style=' margin:10px auto'>
        <div class="undercondition" style='width:85%;'>
                <h3>
                Data Deletion and Retention
                    <hr class="Retentionline" />
                </h3>
            </div>
                <p style='width:85%;'>
...
<div class="yourrights">
    <div class="leftrights">
    <h3>
    Your Rights
                    <hr class="Yourrightsline" />
                </h3>
                <p style='padding-right: 5%;'> You may access, rectify, and update your personal data directly through the functionalities 
                provided on the Platform.</p>
                <h3>
                Changes to this Privacy Policy
                    <hr class="changesline" />
                </h3>
                <p style='padding-right: 5%;'> Please check our Privacy Policy periodically for changes. We may 
...
laws.</p>
    ...
    <div class="rightrights">
    <div class="handbox"></div>
    <img class="hand-image" src="{{url('images/hand.png')}}" alt="">
</div>
