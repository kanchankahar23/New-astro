            ...
            <div class="transaction"
                ...
                <div class="historypayment" style="margin-bottom: 32px;width:87%;">
                    <div class="panditprofile" style="margin-left: 15px;">
                        <img src="{{ url($debit->getAstrologer->avtar ?? 'website_dashboard_assets/assets/images/ram-nath.jpg') }}"
                            alt="">
                    </div>
                    <div class="nameofmoneyrecieved">
                        <h4>{{ ucfirst($debit->getAstrologer->name) }}</h4>
                        <p>{{ $debit->created_at->format('d M, Y , h:i A') }}
                        </p>
                    </div>
                    ...
                    <div class="paidpayments">
                        ...
                        <p class="paidsign">Debited<i class="fa-solid fa-circle-check"></i>
                        </p>
                    </div>
                ...
                <div class="historypayment"
                    ...
                    <div class="nameofmoneyrecieved" style="width: auto;">
                        <h4><i style="font-size: 25px;"
                                class="fa-solid fa-hand-holding-dollar"></i> Please visit our astrologer page and schedule an appointment for a call, video
                                call, or chat.
                            </h4>
                    </div>
                </div>
