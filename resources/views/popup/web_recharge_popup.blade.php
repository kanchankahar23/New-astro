...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('popup/web_recharge_popup.css') }}" />
        ...
        <link rel="stylesheet" href="{{ url('assets/pricing-model') }}/pricing.css">
        <link rel="stylesheet"
    ...
    <body>
        ...
        <div class="popupss" id="popup" style="z-index: 99999;">
                        ...
                        <div class="logoLine">
                            ...
                            <div class="textAmount">
                                <p class="biggAmount"> <i
                                    ...
                                    <p class="walletText"><i class="fa-solid fa-wallet"></i>
                                        Needed
                                        Balance</p>
                                    @else
                                    {{ $walletInfo ?? '0' }}
