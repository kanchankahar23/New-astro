...
<html lang="en">
    <head>
        ...
        #doshaPage .mt-4 , #pitraDoshaPage > div , #kaalsharpDoshaPage > div ,
        #papasamayaPage > div{
        width: 100%;
        overflow: hidden;
        ...
        <div id="kundaliModal" class="modal">
            <div class="modal-content" >
                <div class="modal-header" style="margin-top: 3px;">
                    <h5>User Kundali Details
                    </h5>
                    <span class="close" onclick="closeKundliPopup()">&times;</span>
                </div>
                <div>
                    <ul style="border: 1px solid #988c8c38 !important;" id="myTab" role="tablist"
                        ...
                        <li class="nav-item flex-sm-fill listrestheader kundali ">
                            <a href="#basicPage" id="basic-tab" onclick="showPage('basic', this)"
                ...
                <div class="modal-body" style="overflow: auto;">
                    <div class="right-section">
                        ...
                        <div class="two" style="width:40%;">
                            <p><strong>@lang('messages.time') :</strong> {{ $tob
                                ?? '' }}</p>
                            <p title="{{ isset($obj->remark) ? $obj->remark : 'N/A' }}"><strong>@lang('messages.place') :</strong>  {{ isset( $place) ? substr($place, 0, 10) : 'N/A' }}{{
                                strlen($place) > 10 ? '...' : '' }}</p>
                        </div>
                    </div>
