...
<div class="col-sm-12">
                        ...
                        <div class="box">
                            ...
                            <div class="input-group">
                                <input type="file" class="form-control" id="file-input" name="file+"
                                    onchange="ChangeSetImage(this, image_frout, file_text_frount);" accept="image/*">
                                <input type="text" id="file_text_frount" class="form-control" style="display: none"
                                    readonly="" name="profile_image" value="">
                            </div>
                            <div class="d-flex">
    ...
    <div class="col-sm-12">
        <div class="upload_image_box">
            ...
            <div class="btn-group" data-toggle="modal" data-target="#modal_crop">
                <img style="height:300px; width:auto" src="{{ $preview ?? '' }}" alt=""
                    id="myresultimage">
            </div>
            <br>
        </div>
