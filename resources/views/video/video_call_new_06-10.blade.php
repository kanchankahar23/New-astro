                ...
                <div class="video-call-actions" id="stream-controls"
                   ...
                   <button id="toggle-btn" class="video-action-button toggle"
                    ...
                    {{--  <button id="toggleAudioBtn" onclick="toggleMic()"
                        ...
                        <button id="toggleAudioBtn" onclick="toggleMic()"
                            class="video-action-button mic" style="padding: 6px;"><i
                                class="fa-solid fa-microphone"
                                style="color: #ffffff; font-size:23px;"></i> <i
                        ...
                        {{--  <button id="toggleCameraBtn" onclick="toggleCamera()"
                            ...
                            <button id="toggleCameraBtn" onclick="toggleCamera()"
                                class=" video-action-button camera" style="padding: 6px;"><i
                                    class="fa-solid fa-video" style="color: #ffffff; font-size:23px;"></i><i
