        ...
        <div class="container-fluid app-container">
            <div class="app-main">
                <div id="timer-toast-container"
                    class="top-0 p-3 position-fixed end-0"
                ...
                <div id="stream-wrapper" style="position: relative; width: 100%; height: 100%;">
                 @if(Auth::user()->type == 'astrologer')
                        <div class="userdetails"
                            style="text-align: center; padding: 11px 15px; border: 1px solid #ffffff8f;border-radius: 10px !important;position: absolute; top: 83%; left: 50%; width: 35%;object-fit: cover;z-index: 111111;transform: translate(-50%, -50%);z-index: 999;">
                            <p style="margin: 0;  color: #f1dd76;  font-weight: 500;">{{
                                $appointment["name"] ?? ''}}</p>
                            <div
                                style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
                                <p style="color: white; margin: 0;">DOB : </p>
                                <p style="color: white; margin: 0;">{{
                                    \Carbon\Carbon::parse($appointment["dob"])->format('d M Y') }}</p>
                                <p style="color: white; margin: 0;">{{
                                    \Carbon\Carbon::parse($appointment["tob"])->format('H:i') }}</p>
                            </div>
                            <div
                                style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
                                <p style="color: white; margin: 0;">POB : </p>
                                <p style="color: white; margin: 0;"> {{ $appointment["place"] ?? ''}}
                                </p>
                            </div>
                        </div>
                 @endif
