...
<html lang="en">
    ...
    <link rel="icon" href="{{asset('website/astro_link_icon.png')}}" sizes="192x192" />
    ...
    <style>
        ...
        .video-action-button.camera {
            background-image: url("https://cdn3.iconfinder.com/data/icons/linecons-free-vector-icons-pack/32/camera-512.png");
            background-position: center;
        }
        ...
        .video-action-button.endcall {
            ...
            width: 48px;
            object-fit: cover;
            background-image: url(https://uxwing.com/wp-content/themes/uxwing/download/communication-chat-call/end-call-icon.png);
    ...
    <style>
        ...
        @media (max-width: 481px) and (min-width:312px) {
            ...
            .video-call-header {
                ...
                z-index: 99999;
                background: linear-gradient(181deg, rgb(0 0 0 / 64%) 0%, rgb(65 65 65 / 53%) 47%, rgb(255 251 242 / 0%) 77%);
            }
    ...
    <body>
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="col-6">
                <div class="logoo">
                    <div style="white-space: nowrap     margin-top: -25px;" class="al-logo">
                        <a href="" style="display: flex
;">
                            <img src="https://astro-buddy.com/website/uploads/sites/logo23.png" style="height: 40px ; "
                                alt="logo">
                            <h3 class="FontOfAstro" style="color: #fbfbfb !important ; margin-top: 1px;">
                                ASTROBUDDY
                            </h3>
        ...
        <div class="row" id="joining-meeting">
            ...
            {{-- <div class="col-12">
                <input type="text" id="linkname" value="" class="form-control" placeholder="Enter Your Name ">
            </div> --}}
            @endif
            {{-- <div class="mt-2 col-12">
                <input type="text" id="linkUrl" class="form-control" value="{{url('join-meeting')}}/{{$meeting->url}}">
            </div> --}}
       ...
       <div class="container-fluid app-container">
        <div class="app-main">
            <div id="timer-toast-container" class="top-0 p-3 position-fixed end-0"
            ...
            <div id="stream-wrapper">
                ...
                <video id="localVideo" class="leargPeer" autoplay muted playsinline></video>
                <video id="remoteVideo" class="smallPeer" autoplay playsinline></video>
            </div>
            {{-- <div id="popup"
            ...
            <div class="row">
                <div class="col-3">
                    <button class="btn btn-primary" onclick="makeCall()">Make Call</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-primary" onclick="answerCall()">Answer</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-primary" onclick="toggleCamera()">Toggle
                        Camera</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-primary" onclick="toggleMic()">Toggle
                        Mic</button>
                </div>
                <br>
                <div class="col-3">
                    <button class="btn btn-primary" onclick="flipCamera()">Flip
                        Camera</button>
                </div>
            </div> --}}
            <div class="mt-2 text-center col-12 headLinks">
                ...
                --}}
                <button id="join-btn2" class="accept" onclick="makeCall()">Join
                    Call</button>
                <button id="join-btn" style="display: none;"></button>

                <button id="join-btns" class="accept" onclick="copyLink()" style="background:#ff0808c9 !important;">Copy
                    Link</button>
                ...
                {{-- <button id="openModalBtn" class="view" onclick="loadPopup(openKundliPopup)">View
                    Kundli</button> --}}
            ...
            <div class="video-call-actions" id="stream-controls" style="display: none;">

                @if (Auth::user()->type == 'astrologer')
                <button id="openModalBtn" class="video-action-button kundali" style="padding: 0;"><i
                        class="fa-solid fa-star-of-david" style="color: #ffffff;font-size: 23px;"></i></button>
                @endif
                <button id="toggle-btn" class="video-action-button toggle" onclick="toogleClass()"
                    style="padding: 6px;"><i class="fa-solid fa-arrow-up-right-from-square"
                        style="color: #ffffff; font-size: 23px;"></i></button>
                {{-- <button id="leave-btn" class="video-action-button endcall leavebtn" onclick="leaveCall()"></button>
                --}}

                <button id="leave-btn" class="video-action-button endcall leavebtn"
                    onclick="stopTimer(onTimerStopped)"></button>
                <button id="toggleAudioBtn" onclick="toggleMic()" class="video-action-button mic"
                    style="padding: 6px;"><i class="fa-solid fa-microphone"
                        style="color: #ffffff; font-size:23px;"></i> <i class="fa-solid fa-microphone-slash"
                        style="color: #ffffff;font-size: 23px;"></i></button>


                <button id="toggleCameraBtn" onclick="toggleCamera()" class=" video-action-button camera"
                    style="padding: 6px;"><i class="fa-solid fa-video" style="color: #ffffff; font-size:23px;"></i><i
                        class="fa-solid fa-video-slash" style="color: #ffffff; font-size: 23px;"></i></button>
                {{-- <button id="joinCallBtn" onclick="tryJoinCall()">📞
    ...
    var userTypes = "{{Auth::user()->type}}";
        ...
        console.log(`📞 Opponent (${data.userId}) joined the call UI update`);
        document.getElementById('stream-controls').style.display = 'flex';
        document.getElementsByClassName('headLinks')[0].style.display = 'none';
        });
        </script>  --}}
