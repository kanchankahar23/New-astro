          ...
          ========================= -->
                    <div
                        ...
                        <div class="container py-5 my-auto">
                            <div class="row g-0">
                                <div
                                    class="mx-auto text-center col-10 col-md-9">
                                    ...
                                    <form id="loginForm" class="form-border"
                                        action="{{ route('send.email.otp') }}"
                                        method="post">
                                        @csrf
                                        @method('POST')
                                        <div class="mb-3">
                                        ...
                                        <p class="text-2">Already User in
                                            AstroBuddy &nbsp; <a
...
">
        ...
        <div id="styles-switcher" class="right">
            ...
            <ul class="mb-0">
                ...
                <li class="pink" data-bs-toggle="tooltip"
                    data-path="css/color-pink.css" aria-label="Pink"
                    data-bs-original-title="Pink"></li>
                <li class="red" data-bs-toggle="tooltip"
                    data-path="css/color-red.css" aria-label="Red"
                ...
                <li class="teal" data-bs-toggle="tooltip"
                    data-path="css/color-teal.css" aria-label="Teal"
                ...
                <li class="cyan" data-bs-toggle="tooltip"
                    data-path="css/color-cyan.css" aria-label="Cyan"
