          ...
          ========================= -->
                <div class="order-2 shadow-lg col-md-6 col-lg-5 col-xl-4 d-flex flex-column bg-light order-md-1">
                        ...
                        <div class="row g-0">
                            <div class="mx-auto text-center col-10 col-md-9">
                                ...
                                <form id="loginForm" class="form-border" method="post" action="javascript:void(0)">
                                    <div class="mb-3">
                                        <input type="number" placeholder="Enter Your Mobile Number" minlength="10" id="mobile" class="form-control">
                                    <div id="response" style="color:red"></div>
                                    </div>
                                    <div class="my-4 d-grid">
                                        <button class="btn btn-primary text-uppercase" type="button" onclick="getOtp()">Generate OTP</button>
                                    </div>
                                </form>
                    ...
                    <div class="container py-2">
                        <p class="mb-0 text-center text-2 text-muted">Copyright © 2024 <a href="#">Astro-Buddy</a>. All Rights
                            Reserved.</p>
                    </div>
                </div>
                <!-- Login Form End -->
    ...
    <script>
        ...
        function getOtp() {
            try {
                ...
                const apiUrl = "{{ url('api/get-number') }}"; // Replace this with your actual API URL
