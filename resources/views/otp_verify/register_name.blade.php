                        ...
                        <div class="row g-0">
                            <div class="mx-auto text-center col-10 col-md-9">
                                ...
                                <form id="loginForm" class="form-border" method="post">
                                    <div class="mb-3">
                                            <input name="name" id="name" placeholder="Enter Full Name" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <input list="browsers" name="gender" id="gender" placeholder="Select Gender" class="form-control">
                                    ...
                                    <div class="my-4 d-grid">
                                        <button class="btn btn-primary text-uppercase" type="button" onclick="register()">Register</button>
                                    </div>
                                </form>
                                <p class="text-2">New to Astro-Buddy? <a href="{{ url('/login') }}">Login</a></p>
                            </div>
                        </div>
                    </div>
...
">
   ...
   function register() {
           try {
               ...
               const apiUrl = "{{ url('api/register-details-save') }}"; // Replace this with your actual API URL

               // Data to be sent in the request body
               const postData = {
                    user_name:details[0].value,
                    user_gender:details[1].value,
                   _token: "{{ csrf_token() }}",
               };
