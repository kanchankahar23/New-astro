          ...
          ========================= -->
                <div class="order-2 shadow-lg col-md-6 col-lg-5 col-xl-4 d-flex flex-column bg-light order-md-1">
                    <div class="container py-5 my-auto">
                        <div class="row g-0">
                            <div class="mx-auto text-center col-10 col-md-9 otpForMobile">
                                ...
                                <form id="loginForm" method="post" action="javascript:void(0)" class="form-inline">
                                    ...
                                    ">
                                        <button class="btn btn-primary text-uppercase" type="button" onclick="verifyOtp()">Verify OTP</button>
                                    </div>
                                </form>
                                 <span onclick="location.reload()" style="cursor:pointer;z-index: 5;">Resend OTP  </span>
                                 <br>
                                <a href="{{ url('/email-form') }}">
                                    <span style="cursor:pointer;z-index: 5;">Register
                                        With Email</span></a>
                                 {{--  {{ $storedOtp }}  --}}
                            </div>
                        </div>
    ...
    <script>
        function verifyOtp() {
            try {
                ...
                const apiUrl = "{{ url('/register-otp-verify') }}"; // Replace this with your actual API URL
