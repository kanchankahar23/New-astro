...
<body>
    ...
    <div class="appointfirst">
        ...
        <h3>Free Numerology Online - Get Your radical number with Characteristics.
            <hr style="width: 73%;">
        </h3>
        <p>At Astrobuddy, we offer a free and accurate numerology reading that can help you decode the hidden messages in your numbers. Whether you are curious about your career prospects, love life, or personal growth, our numerology insights are tailored to guide you on your journey. Our readings are prepared with the utmost precision, consulting with numerology experts to ensure authenticity and reliability.</p>

    </div>
    <div class="appointastrojd NumeroJdFile" style="width: 83%;">
        <div class="appform">
            <h3 style="text-align: left; width: 86%;">Get Numerology</h3>
            <h4 class="tagline" style="width: 85.7%; margin-top: -35px; margin-bottom: 15px;"><span></span></h4>
            <form action="{{ url('/get-numerology-details') }}" method="POST">
                @csrf
                @method('POST')
