...
<div class="p-2 appform">
  <div class="innerforms"><br>
    <div class="tagchart1 scrollbar" style="overflow: auto;">
      <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'D9' ? 'active' : '' }}"
        onclick="activateTab(this); showPage('kundli', this);getKundliChart('D9', '@lang('messages.navamsha')')">@lang('messages.navamsha')</a>
      <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'moon' ? 'active' : '' }}"
        onclick="showPage('kundli', this), getKundliChart('moon', '@lang('messages.moon')')">@lang('messages.moon')</a>
      <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'chalit' ? 'active' : '' }}"
        onclick="showPage('kundli', this), getKundliChart('chalit', '@lang('messages.chalit')')">@lang('messages.chalit')</a>
     
      <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'sun' ? 'active' : '' }}"
        onclick="showPage('kundli', this), getKundliChart('sun', '@lang('messages.sun')')">@lang('messages.sun')</a>
        <a href="#kundliPage"
          class="chartbutton {{ $chartName == 'kp_chalit' ? 'active' : '' }}"
          onclick="showPage('kundli', this),getKundliChart('kp_chalit', '@lang('messages.kPChalit')')">@lang('messages.kPChalit')</a>
    </div>
    <div class="tagchart2 scrollbar" style="overflow: auto;">
     
      <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'D2' ? 'active' : '' }}"
        onclick="showPage('kundli',this),getKundliChart('D2', '@lang('messages.hora')')">@lang('messages.hora')</a>
        <a href="#kundliPage"
            class="chartbutton {{ $chartName == 'D3' ? 'active' : '' }}"
            onclick="showPage('kundli',this),getKundliChart('D3', '@lang('messages.drekkana')')">@lang('messages.drekkana')</a>
         <a href="#kundliPage"
        class="chartbutton {{ $chartName == 'D7' ? 'active' : '' }}"
        onclick="showPage('kundli', this), getKundliChart('D7', '@lang('messages.saptamansha')')">@lang('messages.saptamansha')</a>
         <a href="#kundliPage"
    ...
    <div class="container" style="width:max-width;">
      <div class="tableliner">
        <h5 id="chartTitle" class="birth" style="text-align: center;">
          @lang('messages.birthChart')
