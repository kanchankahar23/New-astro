                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-6 invoice-id">
                                        <div class="info">
                                            ...
                                            <p class="color-white mb-1">Invoice Number <span>{{ $payment->id ?? '0' }}</span></p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            ...
                                            <h2 class="name mb-10">{{ $payment->GetTransection->name ?? Auth::user()->name }}</h2>
                                            <p class="invo-addr-1">
                                                {{ ucfirst($payment->GetTransection->type ?? 'Astrologer') }} <br/> {{ $payment->GetTransection->email ?? Auth::user()->email }} <br/> {{ $payment->GetTransection->address ?? '145 Mahananda Madan Mahal, Jabalpur, M.P, India' }} <br/>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            <div class="invoice-number-inner">
                                                ...
                                                <p class="invo-addr-1">
                                                    www.astro-buddy.com <br/> support@astro-buddy.com <br/> 145 Mahananda Jbp, india <br/>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-striped invoice-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr">
                                                <td><div class="item-desc-1"><span>{{ ++$i }}</span></div></td>
                                                <td class="pl0">{{ $payment->plan_name ?? 'plan' }}</td>
                                                <td class="text-center">{{ $payment->razorpay_payment_id ?? '0' }}</td>
                                                <td class="text-center">{{ $payment->created_at->format('d M, Y') }}</td>
                                                <td class="text-end">{{ $payment->amount ?? '0' }}.00</td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr class="tr2">
                                                ...
                                                <td class="f-w-600 text-end active-color">{{ $sumofAmount ?? '00.00' }}.00 &#8377;</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
