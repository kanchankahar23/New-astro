                ...
                <div class="col-lg-12">
                    <div class="invoice-inner clearfix">
                                ...
                                <div class="row g-0">
                                    <div class="col-sm-6">
                                        <div class="invoice-logo">
                                                <img style="height: 25px;" src="{{ asset('website_dashboard_assets/assets/images/AstroLogo.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 invoice-id">
                                        <div class="info">
                                            <h1 class="color-white inv-header-1">Invoice</h1>
                                            <p class="color-white mb-1">Invoice Number<span>AB110011{{ $payment->id }}</span></p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            ...
                                            <p class="invo-addr-1">
                                                {{ ucfirst($payment->GetTransection->type) }} <br/> {{ $payment->GetTransection->email ?? '-' }} <br/> {{ $payment->GetTransection->address ??'' }} <br/>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            <div class="invoice-number-inner">
                                                ...
                                                <p class="invo-addr-1">
                                                    www.astro-buddy.com <br/> support@astro-buddy.com
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table mb-0 table-striped invoice-table">
                                        ...
                                        <tbody>
                                            <tr class="tr">
                                                ...
                                                {{--  <td class="pl0">-</td>  --}}
                                                <td class="text-center">{{ $payment->order_id ?? '0' }}</td>
                                                <td class="text-center">{{ $payment->created_at->format('d M, Y') }}</td>
                                                <td class="text-end">
                                                   @if (!empty($payment->credits))
                                                  {{ $payment->credits ?? '0' }}
                                                    @elseif(!empty($payment->debits))
                                                    {{ $payment->debits ?? '0' }}
                                                    @endif
                                            </td>
                                            </tr>
                                            <tr class="tr2">
                                                ...
                                                <td class="text-end">{{ $payment->getPackage->gst ?? 18 }} %</td>
                                            </tr>
                                            <tr class="tr2">
                                                <td></td>
                                                <td></td>
                                                ...
                                                <td class="f-w-600 text-end active-color">{{ $payment->amount ?? '00.00' }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-lg-9 col-md-11 col-sm-12">
                                        <div class="contact-info">
                                            <a href=""><i class="fa fa-phone"></i> +91 9294-54-9294</a>
                                            <a href=""><i class="fa fa-envelope"></i> support@astro-buddy.com</a>
                        ...
                        <div class="invoice-btn-section clearfix d-print-none">
                            <a style="background: linear-gradient(to bottom, #ffb400, #ff8a00) !important;" href="javascript:window.print()" class="btn btn-lg btn-print">
