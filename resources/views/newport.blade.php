...
<head>
  ...
  /* =================================== */
        ...
        .primary-menu.navbar-line-under-text ul.navbar-nav>li>a:not(.btn):after {
            ...
            background-color: transparent;
            color: #fff;
            border-bottom: 2px solid #f1e233;
        ...
        .secondary-nav.nav.alternate .nav-item .nav-link.active {
            background-color: transparent;
            color: #1e1d1c;
            border-bottom: 3px solid #f1e233;
        }
  ...
  /* =================================== */
        ...
        .bg-primary {
            background-color: #f1e233 !important;
        }
 ...
 */
        ...
        *,
        ...
        .btn-primary {
            ...
            --bs-btn-disabled-bg: #f1e233;
            ;
            --bs-btn-disabled-border-color: #f1e233;
        }
        ...
        .btn-outline-primary {
            ...
            ;
            --bs-btn-hover-color: #fff;
            --bs-btn-hover-bg: #f1e233;
            ;
            --bs-btn-hover-border-color: #f1e233;
            ;
            --bs-btn-focus-shadow-rgb: 13, 110, 253;
            --bs-btn-active-color: #fff;
            --bs-btn-active-bg: #f1e233;
            ;
            --bs-btn-active-border-color: #f1e233;
            ;
            --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
            --bs-btn-disabled-color: #f1e233;
            ;
        ...
        .dropdown-menu {
            ...
            --bs-dropdown-link-active-bg: #f1e233;
            ;
        ...
        .nav-pills {
            ...
            --bs-nav-pills-link-active-bg: #f1e233;
        }
        ...
        .pagination {
            ...
            --bs-pagination-active-bg: #f1e233;
            ;
            --bs-pagination-active-border-color: #f1e233;
            ;
        ...
        .list-group {
            ...
            --bs-list-group-active-bg: #f1e233;
            ;
            --bs-list-group-active-border-color: #f1e233;
            ;
            display: flex;
            flex-direction: column;
            padding-left: 0;
            ...
            <nav class="primary-menu navbar navbar-expand-lg navbar-dark bg-dark border-bottom-0">
                <div class="container-fluid position-relative h-100 flex-lg-column ps-3 px-lg-3 pt-lg-3 pb-lg-2">
                    ...
                    <a href="index.html" class="mb-lg-auto mt-lg-4">
                        ...
                        <h1 class="text-5 text-white text-center mb-0 d-lg-block">Gura Shiva</h1>
                    </a>
                    <!-- Logo End -->
                ...
                <div class="container px-lg-5">
                    ...
                    <div class="row gy-5">
                        <div class="col-lg-7 col-xl-8 text-center text-lg-start">
                            <h2 class="text-7 fw-600 mb-3">I'm <span class="text-primary">Guru Shiva,</span> a Astro
                                Experty</h2>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="ps-lg-4">
                                <ul class="list-style-2">
                                    <li class=""><span class="fw-600 me-2">Name:</span>Shiva Guru</li>
                                    <li class=""><span class="fw-600 me-2">Email:</span><a
                                            href="mailto:chat@simone.com">shiva@srr.com</a></li>
                                    <li class=""><span class="fw-600 me-2">Age:</span>28</li>
                                    <li class="border-0"><span class="fw-600 me-2">From:</span>Vanaras
                                    </li>
                                </ul>
