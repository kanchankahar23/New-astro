                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <div id="example_wrapper">
                                    <form action="{{ url('users/user-list') }}" method="GET">
                                        <div class="row">
                                            <div
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="py-1" colspan="2">
                                                        <div class="d-flex align-items-center">
                                                          <div>
                                                            <img src="{{ url($user['avtar'] ?? '-') }}" alt="image" style="width: 40px;
                                                              border-radius: 20px;">
                                                          </div>
                                                          <div class="p-3">
                                                      ...
                                                      <td class="text-center">
                                                        <label class="badge badge-success"> {{ ucwords($user['sub_type'] ?? '--/--') }}</label>
                                                        </td>
                                                      <td>
                                                        @php
                                                       ...
                                                       <a href="{{ url('/users/edit-user', $user->id) }}"><i class="mdi mdi-border-color" style="cursor: pointer;"></i></a>
